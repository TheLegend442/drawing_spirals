...
def main():
    ...
    match args.spiral_type:
        case "normal":
            for _ in range(args.num_spirals):
                spiral_params = {
                ...
                spiral_dicts.append(spiral_dict)
    ...
    for idx, spiral_dict in enumerate(spiral_dicts):
        np.savez(
            f"{output_dir}/{args.spiral_type}_{idx}.npz",
            theta=spiral_dict['theta'],
            r=spiral_dict['r'],
            type_labels=spiral_dict['type_labels'],
            tightness_severity=spiral_dict['tightness_severity'],
            params=np.array(spiral_dict['params'])
        )
